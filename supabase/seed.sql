...
CREATE INDEX idx_activity_templates_phase ON activity_templates(phase);
CREATE INDEX idx_activity_templates_difficulty ON activity_templates(difficulty);
CREATE INDEX idx_activity_templates_type ON activity_templates(type);
CREATE INDEX idx_activity_templates_personas ON activity_templates USING GIN(personas);
CREATE INDEX idx_activity_templates_work_types ON activity_templates USING GIN(work_types);